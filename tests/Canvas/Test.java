...
class Game extends Canvas {
	public void paint(Graphics g) {
		...
		try {
			...
			g.drawRegion(img, 10, 10, 20, 20, Sprite.TRANS_MIRROR_ROT270, 100, 100, 0);
			g.drawRegion(img, 10, 10, 20, 20, Sprite.TRANS_ROT90, 150, 100, 0);
			g.drawRegion(img, 10, 10, 20, 20, Sprite.TRANS_MIRROR_ROT90, 100, 150, 0);
			g.drawRegion(img, 10, 10, 20, 20, Sprite.TRANS_ROT180, 150, 150, 0);
